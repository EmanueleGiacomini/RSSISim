...
namespace rssisim {
    class AxisAlignedBoundingBox : public Obstacle {
        ...
        AxisAlignedBoundingBox(Eigen::Vector2f _vert_min, Eigen::Vector2f _vert_max, std::shared_ptr<PathLoss> _obst_loss): vert_min(_vert_min), vert_max(_vert_max), Obstacle(_obst_loss) {}
